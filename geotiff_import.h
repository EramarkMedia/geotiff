#ifndef GEOTIFF_IMPORT_H
#define GEOTIFF_IMPORT_H
...
class GeotiffImportPlugin : public ResourceImporter {
	GDCLASS(GeotiffImportPlugin, ResourceImporter);
protected:
